...
module.exports = new CommandBlock({
  ...
  if (!guild.available) return message.channel.send("Guild was marked as unavailable and thus could not be interacted with. This is indicative of a server outage.");
  try {
    await guild.leave();
  } catch (error) {
