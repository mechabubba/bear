...
module.exports = [
  ...
  new ListenerBlock({ event: "ready" }, (client) => log.info(`${chalk.green("[READY]")} ${client.user.tag} is ready and serving ${client.guilds.cache.size} ${!client.guilds.cache.size ? "guild" : "guilds"}`)),
